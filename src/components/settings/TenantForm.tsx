  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-xl font-bold text-brand-light">Tenant Information</h3>
          <p className="text-sm text-brand-muted">Current tenant and lease details</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="card bg-brand-navy/50 p-3 flex flex-col justify-center">
          <p className="text-xs text-brand-muted">Lease Duration</p>
          <p className="text-lg font-bold text-brand-light">{leaseDuration} months</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            step="100"
          />
          <p className="text-xs text-brand-muted mt-1">{formatCurrency(formData.securityDeposit)}</p>
        </div>
      </div>
